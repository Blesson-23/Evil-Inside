...
TECHNO_IMG = "https://telegra.ph/file/a9c52fa15d3e13ed92775.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="𝙷𝙴𝙻𝙿",
                                                                       ...
                                                                       url="https://t.me/+7jaTb5ZDTL8zMGI1")],
                                                                                   [InlineKeyboardButton(text= "DEV 1",
                                                                       url="t.me/blesson_3"),
                                                                                   InlineKeyboardButton(text="DEV 2",
                                                                       url="t.me/cyber_demon")
                                                                                 ]]))
